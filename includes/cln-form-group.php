<div class="cln" style="margin: 10px 0;">
  ...
  <button type="submit" class="button" name="apply_cln" style="background: #264cad; color: #fff;">Club La Nación</button>

  <?php $disabled = ! WC()->session->get("is_cln_member") ? "disabled" : ""; ?>

  <button type="submit" class="button" name="remove_cln" style="background: #c0392b; color: #fff;" <?= $disabled  ?>>Eliminar</button>
</div>
